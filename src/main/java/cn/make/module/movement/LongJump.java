...
public class LongJump extends Module {
    ...
    public Setting<Mode> mode = rother("Mode", Mode.TICK);
    public Setting<Float> boost = rfloa("Boost", 4.48f, 1f, 20f, v -> mode.getValue() == Mode.DIRECT);
    public Setting<Boolean> lagOff = rbool("LagBackCheck", true);
    public Setting<Boolean> step = rbool("SetStep", false);
    public Setting<Boolean> autoOff = rbool("AutoOff", true);
    public Setting<Boolean> dealDMG = rbool("DealDamage", true);
    public Setting<Boolean> updateY = rbool("UpdateY", true);
    public int stage;
    ...
    public LongJump() {
        super("LongJump", "Kura Moment", Category.MOVEMENT);
    }
    ...
    public void onEnable() {
        ...
        if (mc.gameSettings.keyBindSneak.isKeyDown()) {
            notiMessage("cancel LongJump cause Sneaking");
            disable();
        }
    }
