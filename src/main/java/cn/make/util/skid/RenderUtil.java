...
implements Util {
    ...
    public static void drawText(AxisAlignedBB axisAlignedBB, String string) {
        ...
        GlStateManager.pushMatrix();
        RenderUtil.glBillboardDistanceScaled((float)axisAlignedBB.minX + 0.5f, (float)axisAlignedBB.minY + 0.5f, (float)axisAlignedBB.minZ + 0.5f, mc.player, 1.0f);
        GlStateManager.disableDepth();
        GlStateManager.translate(-((double) Client.textManager.getStringWidth(string) / 2.0), 0.0, 0.0);
    ...
    public static void glScissor(float f, float f2, float f3, float f4, ScaledResolution scaledResolution) {
        GL11.glScissor((int)(f * (float)scaledResolution.getScaleFactor()), (int)((float) mc.displayHeight - f4 * (float)scaledResolution.getScaleFactor()), (int)((f3 - f) * (float)scaledResolution.getScaleFactor()), (int)((f4 - f2) * (float)scaledResolution.getScaleFactor()));
    }
    ...
    public static void drawBlockOutline(BlockPos blockPos, Color color, float f, boolean bl) {
        ...
        if ((bl || iBlockState.getMaterial() != Material.AIR) && mc.world.getWorldBorder().contains(blockPos)) {
            Vec3d vec3d = EntityUtil.interpolateEntity(mc.player, mc.getRenderPartialTicks());
            RenderUtil.drawBlockOutline(iBlockState.getSelectedBoundingBox(mc.world, blockPos).grow(0.002f).offset(-vec3d.x, -vec3d.y, -vec3d.z), color, f);
        }
    }
    ...
    public static void drawGradientPlane(BlockPos blockPos, EnumFacing enumFacing, Color color, Color color2, double d) {
        ...
        IBlockState iBlockState = mc.world.getBlockState(blockPos);
        Vec3d vec3d = EntityUtil.interpolateEntity(mc.player, mc.getRenderPartialTicks());
        AxisAlignedBB axisAlignedBB = iBlockState.getSelectedBoundingBox(mc.world, blockPos).grow(0.002f).offset(-vec3d.x, -vec3d.y, -vec3d.z).expand(0.0, d, 0.0);
    ...
    public static void drawText(String s, double x, double y, double z) {
        ...
        GlStateManager.disableDepth();
        GlStateManager.translate(-((double) Client.textManager.getStringWidth(s) / 2.0), 0.0, 0.0);
    ...
    public static void drawBlockOutline(BlockPos blockPos, Color color, float f, boolean bl, double d, boolean bl2, boolean bl3, int n, boolean bl4) {
        ...
        IBlockState iBlockState = mc.world.getBlockState(blockPos);
        if ((bl || iBlockState.getMaterial() != Material.AIR) && mc.world.getWorldBorder().contains(blockPos)) {
            AxisAlignedBB axisAlignedBB = new AxisAlignedBB((double)blockPos.getX() - mc.getRenderManager().viewerPosX, (double)blockPos.getY() - mc.getRenderManager().viewerPosY, (double)blockPos.getZ() - mc.getRenderManager().viewerPosZ, (double)(blockPos.getX() + 1) - mc.getRenderManager().viewerPosX, (double)(blockPos.getY() + 1) - mc.getRenderManager().viewerPosY + d, (double)(blockPos.getZ() + 1) - mc.getRenderManager().viewerPosZ);
    ...
    public static void drawCircle(float f, float f2, float f3, float f4, Color color) {
        AxisAlignedBB axisAlignedBB = new AxisAlignedBB((double)f - mc.getRenderManager().viewerPosX, (double)f2 - mc.getRenderManager().viewerPosY, (double)f3 - mc.getRenderManager().viewerPosZ, (double)(f + 1.0f) - mc.getRenderManager().viewerPosX, (double)(f2 + 1.0f) - mc.getRenderManager().viewerPosY, (double)(f3 + 1.0f) - mc.getRenderManager().viewerPosZ);
        camera.setPosition(Objects.requireNonNull(mc.getRenderViewEntity()).posX, mc.getRenderViewEntity().posY, mc.getRenderViewEntity().posZ);
        if (camera.isBoundingBoxInFrustum(new AxisAlignedBB(axisAlignedBB.minX + mc.getRenderManager().viewerPosX, axisAlignedBB.minY + mc.getRenderManager().viewerPosY, axisAlignedBB.minZ + mc.getRenderManager().viewerPosZ, axisAlignedBB.maxX + mc.getRenderManager().viewerPosX, axisAlignedBB.maxY + mc.getRenderManager().viewerPosY, axisAlignedBB.maxZ + mc.getRenderManager().viewerPosZ))) {
    ...
    public static void drawBBFill(AxisAlignedBB axisAlignedBB, Color color, int n) {
        AxisAlignedBB axisAlignedBB2 = new AxisAlignedBB(axisAlignedBB.minX - mc.getRenderManager().viewerPosX, axisAlignedBB.minY - mc.getRenderManager().viewerPosY, axisAlignedBB.minZ - mc.getRenderManager().viewerPosZ, axisAlignedBB.maxX - mc.getRenderManager().viewerPosX, axisAlignedBB.maxY - mc.getRenderManager().viewerPosY, axisAlignedBB.maxZ - mc.getRenderManager().viewerPosZ);
        camera.setPosition(Objects.requireNonNull(mc.getRenderViewEntity()).posX, mc.getRenderViewEntity().posY, mc.getRenderViewEntity().posZ);
        if (camera.isBoundingBoxInFrustum(new AxisAlignedBB(axisAlignedBB2.minX + mc.getRenderManager().viewerPosX, axisAlignedBB2.minY + mc.getRenderManager().viewerPosY, axisAlignedBB2.minZ + mc.getRenderManager().viewerPosZ, axisAlignedBB2.maxX + mc.getRenderManager().viewerPosX, axisAlignedBB2.maxY + mc.getRenderManager().viewerPosY, axisAlignedBB2.maxZ + mc.getRenderManager().viewerPosZ))) {
            GlStateManager.pushMatrix();
            GlStateManager.enableBlend();
            GlStateManager.disableDepth();
            GlStateManager.tryBlendFuncSeparate(770, 771, 0, 1);
    ...
    public static void drawBBBox(BlockPos blockPos, Color color) {
        ...
        AxisAlignedBB axisAlignedBB3 = new AxisAlignedBB(axisAlignedBB2.minX - mc.getRenderManager().viewerPosX, axisAlignedBB2.minY - mc.getRenderManager().viewerPosY, axisAlignedBB2.minZ - mc.getRenderManager().viewerPosZ, axisAlignedBB2.maxX - mc.getRenderManager().viewerPosX, axisAlignedBB2.maxY - mc.getRenderManager().viewerPosY, axisAlignedBB2.maxZ - mc.getRenderManager().viewerPosZ);
        camera.setPosition(Objects.requireNonNull(mc.getRenderViewEntity()).posX, mc.getRenderViewEntity().posY, mc.getRenderViewEntity().posZ);
        if (camera.isBoundingBoxInFrustum(new AxisAlignedBB(axisAlignedBB3.minX + mc.getRenderManager().viewerPosX, axisAlignedBB3.minY + mc.getRenderManager().viewerPosY, axisAlignedBB3.minZ + mc.getRenderManager().viewerPosZ, axisAlignedBB3.maxX + mc.getRenderManager().viewerPosX, axisAlignedBB3.maxY + mc.getRenderManager().viewerPosY, axisAlignedBB3.maxZ + mc.getRenderManager().viewerPosZ))) {
            GlStateManager.pushMatrix();
            GlStateManager.enableBlend();
            GlStateManager.disableDepth();
            GlStateManager.tryBlendFuncSeparate(770, 771, 0, 1);
    ...
    public static void glBillboard(float f, float f2, float f3) {
        ...
        Vec3d renderPos = mc.getRenderManager().renderViewEntity.getPositionVector();
    ...
    private static void colorVertex(double d, double d2, double d3, Color color, int n, BufferBuilder bufferBuilder) {
        bufferBuilder.pos(d - mc.getRenderManager().viewerPosX, d2 - mc.getRenderManager().viewerPosY, d3 - mc.getRenderManager().viewerPosZ).color(color.getRed(), color.getGreen(), color.getBlue(), n).endVertex();
    }
    ...
    public static Vec3d getInterpolatedPos(Entity entity, float f, boolean bl) {
        ...
        if (bl) {
            return vec3d2.subtract(mc.getRenderManager().renderViewEntity.getPositionVector());
        }
        return vec3d2;
    }
    ...
    public static void drawGradientBlockOutline(BlockPos blockPos, Color color, Color color2, float f, double d) {
        IBlockState iBlockState = mc.world.getBlockState(blockPos);
        Vec3d vec3d = EntityUtil.interpolateEntity(mc.player, mc.getRenderPartialTicks());
        RenderUtil.drawGradientBlockOutline(iBlockState.getSelectedBoundingBox(mc.world, blockPos).grow(0.002f).offset(-vec3d.x, -vec3d.y, -vec3d.z).expand(0.0, d, 0.0), color, color2, f);
    }
    ...
    public static void drawFadingOutline(BlockPos blockPos, Color color, Color color2, float f, double d) {
        IBlockState iBlockState = mc.world.getBlockState(blockPos);
        Vec3d vec3d = RenderUtil.getInterpolatedPos(mc.player, mc.getRenderPartialTicks(), false);
        RenderUtil.drawFadingOutline(iBlockState.getSelectedBoundingBox(mc.world, blockPos).grow(0.002f).offset(-vec3d.x, -vec3d.y, -vec3d.z).expand(0.0, 0.0, 0.0), color, color2, f, d);
    }
    ...
    public static void drawBoxESP(AxisAlignedBB axisAlignedBB, Color color, boolean bl, Color color2, float f, boolean bl2, boolean bl3, int n, boolean bl4) {
        AxisAlignedBB axisAlignedBB2 = axisAlignedBB.offset(-mc.getRenderManager().viewerPosX, -mc.getRenderManager().viewerPosY, -mc.getRenderManager().viewerPosZ);
        camera.setPosition(Objects.requireNonNull(mc.getRenderViewEntity()).posX, mc.getRenderViewEntity().posY, mc.getRenderViewEntity().posZ);
