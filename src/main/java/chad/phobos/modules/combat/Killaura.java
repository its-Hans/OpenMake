...
import chad.phobos.api.utils.DamageUtil;
import chad.phobos.api.utils.EntityUtil;
...
public class Killaura extends Module {
    ...
    public Killaura() {
        super("Aura", "kn1ftb0t", Module.Category.COMBAT, true, false, false);
    }
    ...
    private void doKillaura() {
        ...
        int wait = !this.delay.getValue().booleanValue() ? 0 : (int) (DamageUtil.getCooldownByWeapon(mc.player) * (this.tps.getValue().booleanValue() ? Client.serverManager.getTpsFactor() : 1.0F));
