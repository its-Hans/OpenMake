package chad.phobos.modules.movement;
...
public class FastFall extends Module {
    ...
    private final Setting<Mode> mode =
            register(new Setting<>("Mode", Mode.FAST));
    private final Setting<Boolean> noLag =
            register(new Setting<>("NoLag", true, v -> mode.getValue() == Mode.FAST));
    private final Setting<Integer> height =
            register(new Setting<>("Height", 10, 1, 20));
