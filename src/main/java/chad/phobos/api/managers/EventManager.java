...
import chad.phobos.api.events.client.EventUpdate;
import chad.phobos.modules.client.HUD;
import chad.phobos.modules.misc.PopCounter;
import com.google.common.base.Strings;
import com.mojang.realmsclient.gui.ChatFormatting;
import chad.phobos.Client;

import chad.phobos.api.events.network.ConnectionEvent;
import chad.phobos.api.events.network.PacketEvent;
import chad.phobos.api.events.player.DeathEvent;
import chad.phobos.api.events.player.TotemPopEvent;
...
public class EventManager extends Feature {
    ...
    public void onIssus(TickEvent.PlayerTickEvent e) {
        ...
        MinecraftForge.EVENT_BUS.post(eu);
    }
