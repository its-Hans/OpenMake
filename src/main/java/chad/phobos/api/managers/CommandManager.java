...
import chad.phobos.features.commands.*;
...
public class CommandManager
    ...
    private String clientMessage = tweaksClient.clientname;
    private String prefix = tweaksClient.defaultPrefix;
    ...
    public void setPrefixTwo(String prefix) {
        tweaksClient.getInstance().clientPrefix.setValue(prefix);
        tweaksClient.getInstance().enable();
    }
